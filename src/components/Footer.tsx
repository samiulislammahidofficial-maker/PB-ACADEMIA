...
export default function Footer() {
  return (
    <footer className="bg-brand-70 border-t border-white/5 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16">
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="flex items-center space-x-3 group">
              ...
              <span className="font-black text-xl tracking-tighter text-white uppercase group-hover:text-brand-10 transition-colors">PB ACADEMIA</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3 text-neutral-500 font-black uppercase tracking-widest text-[10px]">
              <li><Link to="/" className="hover:text-brand-10 transition-colors">Courses</Link></li>
              <li><Link to="/about" className="hover:text-brand-10 transition-colors">Strategic</Link></li>
              <li><Link to="/contact" className="hover:text-brand-10 transition-colors">Direct Link</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="font-black text-white mb-6 uppercase tracking-widest text-[10px]">Protocols</h4>
            <ul className="space-y-3 text-neutral-500 font-black uppercase tracking-widest text-[10px]">
              <li><Link to="/help" className="hover:text-brand-10 transition-colors">Core Support</Link></li>
              <li><Link to="/privacy" className="hover:text-brand-10 transition-colors">Data Privacy</Link></li>
              <li><Link to="/terms" className="hover:text-brand-10 transition-colors">Usage Terms</Link></li>
            </ul>
          </div>
        </div>
