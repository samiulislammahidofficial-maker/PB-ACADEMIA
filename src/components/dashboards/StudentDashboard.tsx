...
export default function StudentDashboard() {
  ...
  const menuItems = [
    ...
    { icon: Activity, title: "Physics Labs", link: "/physics-labs" },
  ...
  const features = [
    ...
    { icon: Activity, title: "Physics Labs", link: "/physics-labs", color: "bg-indigo-50", iconColor: "text-indigo-500", desc: "Interactive simulations" },
